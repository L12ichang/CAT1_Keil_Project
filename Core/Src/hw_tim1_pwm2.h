...
extern void hw_tim1_pwm2_set_calibrated_PWM_OUT(u16 pwm);
extern void hw_tim1_pwm2_set_calibration_PWM_OUT(u16 pwm);
extern void hw_tim1_pwm2_set_calibration_default_PWM_OUT(u16 pwm);
