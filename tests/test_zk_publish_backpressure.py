...
class ZkPublishBackpressureTests(unittest.TestCase):
    ...
    def test_publish_functions_only_report_success_after_enqueue(self):
        ...
        self.assertLess(login.index("zk_send_payload"), login.index("zk_login_state = ZK_LOGIN_STATE_WAIT_PUBLISH;"))
    ...
    def test_pending_slots_are_lightweight_and_reset_with_session(self):
        ...
        self.assertIn("zk_response_queue_head = 0;", reset)
        self.assertIn("zk_response_queue_count = 0;", reset)
