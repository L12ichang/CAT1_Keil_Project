...
class Phase4LoginHeartbeatTests(unittest.TestCase):
    ...
    def test_time_sync_sources_are_explicit(self):
        ...
        self.assertIn("time_text = zk_json_get_rtc_time_text(tm_cali);", request_handler)
        self.assertIn("zk_apply_server_time_text_ex(time_text, force_apply)", request_handler)
